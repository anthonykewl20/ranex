...
export default class GherkinClassicTokenMatcher implements ITokenMatcher<TokenType> {
  ...
  private matchTitleLine(token: IToken<TokenType>, tokenType: TokenType, keywords: readonly string[]): boolean {
  ...
  private setTokenMatched(token: IToken<TokenType>, matchedType: TokenType, text?: string, keyword?: string, indent?: number, keywordType?: messages.StepKeywordType, items?: readonly Item[]) {
