...
- `ENGREF-FUNDAMENTALS-SOFTWARE-ARCHITECTURE-1E-BOUNDARY-QUANTA`
  ...
  (lines 700–716); and
- `ENGREF-APOSD-1E-COMPLEXITY-SYMPTOMS` (registered PDF, Ch.2, sequence
  pp.18–24), `ENGREF-APOSD-1E-DEEP-MODULES` (Ch.4, pp.31–39),
  `ENGREF-APOSD-1E-INFORMATION-HIDING` (Ch.5, pp.40–49), and
  `ENGREF-APOSD-1E-DESIGN-TWICE` (Ch.11, pp.99–101).
...
microservice boundary. APOSD depth is a consumer-relative qualitative lens,
not permission for god modules or a scalar score, and information hiding
cannot conceal authority, security, failure, recovery, or operational facts.
Clean Architecture needs explicit quality-attribute
