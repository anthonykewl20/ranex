...
`ENGREF-APOSD-1E-DESIGN-TWICE` is applied through the six rejected viable
shapes above (registered PDF, Chapter 11, sequence pages 99–101); this remains
a proportionate alternative record, not a claim that book citation proves the
decision or its runtime outcome.
